...
const docTemplate = `{
    ...
    "paths": {
        "/experiences": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Type (experience/education)",
                        "name": "type",
                        "in": "query"
                    }
                ],
        ...
        "/skills/groups/{group_id}/visibility": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "models.Experience": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "'experience' or 'education'",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
